...
public class Aviation {
   ...
   driver= new FirefoxDriver();
	...
	public void f3() throws InterruptedException{
		...
		driver.findElement(By.xpath("//*[@id='new_user']/div[4]/input")).click();
		driver.findElement(By.id("aircraft_name")).sendKeys("Flight1001");
...
public void fleet() throws InterruptedException{
	...
	public void test123(){
		...
		driver.findElement(By.xpath("//*[@id='men clothing']/div/ul/li[1]/a[2]")).click();
		
		
		//Thread.sleep(5000);
		WebElement element1 = driver.findElement(By.linkText("Tees & Polos"));
